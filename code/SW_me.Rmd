...
plotly_all_themes_str$x$data[[2]]$text <- "Vader's theme - 17"
plotly_all_themes_str$x$data[[3]]$text <- "Jedi Steps - 1"
plotly_all_themes_str$x$data[[4]]$text <- "Droid's theme (TESB) - 11"
plotly_all_themes_str$x$data[[5]]$text <- "Emperor's theme - 18"
plotly_all_themes_str$x$data[[6]]$text <- "Separatist Conspiracy theme - 11"
plotly_all_themes_str$x$data[[7]]$text <- "Luke and Leia's theme - 6"
plotly_all_themes_str$x$data[[8]]$text <- "March of the Resistance - 5"
plotly_all_themes_str$x$data[[9]]$text <- "Duel of the Fates - 4"
plotly_all_themes_str$x$data[[10]]$text <- "Poe's theme - 4"
plotly_all_themes_str$x$data[[11]]$text <- "Camino - 6"
plotly_all_themes_str$x$data[[12]]$text <- "Trade Federation - 4"
plotly_all_themes_str$x$data[[13]]$text <- "Jango's Escape - 1"
plotly_all_themes_str$x$data[[14]]$text <- "Anakin's theme - 7"
plotly_all_themes_str$x$data[[15]]$text <- "Kylo's theme #1 - 10"
plotly_all_themes_str$x$data[[16]]$text <- "Droid's theme (ROTJ) - 3"
plotly_all_themes_str$x$data[[17]]$text <- "Falcon theme - 7"
plotly_all_themes_str$x$data[[18]]$text <- "Death Star - 8"
plotly_all_themes_str$x$data[[19]]$text <- "Arena Monsters - 8"
plotly_all_themes_str$x$data[[20]]$text <- "Leia's theme - 21"
plotly_all_themes_str$x$data[[21]]$text <- "Battle of the Heroes- 8"
plotly_all_themes_str$x$data[[22]]$text <- "Grievous' theme - 3"
plotly_all_themes_str$x$data[[23]]$text <- "Kylo's theme #2 - 2"
plotly_all_themes_str$x$data[[24]]$text <- "Jaba's theme - 3"
plotly_all_themes_str$x$data[[25]]$text <- "Jar Jar's theme - 2"
plotly_all_themes_str$x$data[[26]]$text <- "Scherzo for X-Wings - 3"
plotly_all_themes_str$x$data[[27]]$text <- "Yoda's theme - 22"
plotly_all_themes_str$x$data[[28]]$text <- "Tusken Slaughter - 3"
plotly_all_themes_str$x$data[[29]]$text <- "Rey's theme - 25"
plotly_all_themes_str$x$data[[30]]$text <- "The Force Theme - 103"
plotly_all_themes_str$x$data[[31]]$text <- "Main Title - 89"
plotly_all_themes_str$x$data[[32]]$text <- "Imperial March - 75"
plotly_all_themes_str$x$data[[33]]$text <- "Rebel Fanfare - 39"
plotly_all_themes_str$x$data[[34]]$text <- "Han Solo and the Princess - 31"
plotly_all_themes_str$x$data[[35]]$text <- "Across the Stars - 31"
