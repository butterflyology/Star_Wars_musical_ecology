...
plot(x = seq(from = 0, to = 5, length.out = 4), y = seq(from = 0, to = 20, length.out = 4), xaxt = "n", type = "n", ylab = expression(paste(italic(alpha))), xlab = expression(paste(italic("q"))), las = 1, main = "")
